...
# read data generated by indiviudal_activity_data.m
...
trainY[trainY == -1] = 0
# first 2056 values are output of resnet, later 8 values are x,y,w,h and their slopes
...
for i in range(100):
    ...
    # save predicted values on test set
